		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#insijasrestwithui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"insijasrestwithui5-display": {
								"semanticObject": "insijasrestwithui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=in.sijas.restwithui5",
									"url": sap.ui.require.toUrl("in/sijas/restwithui5")
								}
							}
						}
					}
